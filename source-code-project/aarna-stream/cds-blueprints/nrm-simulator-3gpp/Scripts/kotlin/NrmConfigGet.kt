...
open class NrmConfigGet : AbstractScriptComponentFunction() {

    private val log = LoggerFactory.getLogger(NrmConfigGet::class.java)!!
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        // Store configuration from the CDS DB
         val payload = contentFromResolvedArtifactNB("nrm-config-get")
