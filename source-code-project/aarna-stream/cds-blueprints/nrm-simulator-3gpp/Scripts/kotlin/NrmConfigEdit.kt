...
open class NrmConfigEdit : AbstractScriptComponentFunction() {

    private val log = LoggerFactory.getLogger(NrmConfigEdit::class.java)!!
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        val payload = contentFromResolvedArtifactNB("add-nrm-rrmpolicy")
